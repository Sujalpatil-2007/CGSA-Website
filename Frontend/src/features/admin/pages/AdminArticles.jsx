...
import { Eye, CheckCircle2, XCircle, FilePenLine, Search } from "lucide-react";
...
const AdminArticles = () => {
  ...
  const { handleAdminArticles, handleApproveArticle, handleRejectArticle, handleArticleById } =
    useAdmin();
                    ...
                    <div className="flex justify-center gap-2">
                      <button
                        onClick={async () =>
                          ...
                          await handleArticleById(article._id)
                        }
