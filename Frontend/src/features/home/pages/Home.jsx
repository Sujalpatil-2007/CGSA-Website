    ...
    <div id="main">
      ...
      <div className="min-h-screen w-screen relative dark:bg-gray-900 bg-[#e7dbc490] ">
        <div className="flex justify-center items-center ">
          <div className="h-[10%] lg:h-[25%] lg:w-[90%] w-[98%] absolute   lg:mt-12 flex justify-around items-center rounded-2xl text-center shadow-[0px_0px_10px_0px_black] dark:bg-gray-800 dark:text-white  bg-[#f1eee7db]  ">
        ...
        <div className="h-[50%] w-full lg:p-5  ">
          <div className=" flex justify-between  items-center px-3 lg:px-10  ">
            <h1 className="lg:text-3xl text-xl dark:text-white font-[font2] ">Featured Articles</h1>
            <p onClick={() => {
              navigate("/articles");
