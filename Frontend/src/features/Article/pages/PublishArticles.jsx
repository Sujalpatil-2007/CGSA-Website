    ...
    <div className='h-screen w-screen  bg-[#e5d0a7b9]'>
      ...
      <div className="h-35 lg:pl-15 pl-5 flex flex-col items-start justify-center w-screen dark:bg-gray-800 dark:text-white bg-[#e5d0a7]">
        <div className='flex items-center gap-3'>
          <h1 className='text-4xl lg:pt-3 pt-12 rotate-180 '><Quote fill='black' /> </h1>
          <h1 className='text-xl text-[#2a2929] dark:text-white font-[font2] '>The best way to find yourself is to lose yourself in the service of others.</h1>
        </div>
