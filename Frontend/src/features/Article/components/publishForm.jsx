        ...
        <div className=" lg:h-[90%] w-full ">
          <div className="h-full w-full rounded-2xl border-2 border-[#aba69ca7]  ">
            <form
              ...
              className="h-full dark:bg-gray-800 dark:text-white p-3 w-full"
            >
              {/* Title */}
              <div>
                <label htmlFor="title" className="flex text font-[font2] ">
              ...
              <div className="flex flex-col    w-full   ">
                <div className="flex gap-10 relative ">
                  {/* image url */}
                  <div>
                    <label htmlFor="image" className="flex text font-[font2] ">
                  ...
                  {formData.image && (
                    <div className="h-32 w-52 mt-1 flex gap-3 absolute left-150 ">
                      <img
                        className="bg-[#938a8a51] object-cover rounded "
                        src={formData.image}
                        alt="Image Preview"
                      />
                      <p className="font-[font1] w-56 whitespace-nowrap ">
                        Paste an image URL to <br /> preview your article cover
                        image.
                      </p>
                    </div>
                  )}
                ...
                {/* Author */}
                <div>
                  <label htmlFor="author" className="flex text font-[font2] ">
              ...
              {/* content */}
              <div>
                <label htmlFor="content" className="flex text font-[font2] ">
              ...
              <div className="pt-1">
                <button
                  className="bg-red-400  flex justify-center items-center cursor-pointer active:scale-98 rounded px-3 py-2 left-0 font-[font2] "
